...
third-party-amazon-settings-connect-account = Свързване на акаун
...
third-party-amazon-settings-start-game-directly = Стартиране на игри директно без стартиране на официален клиен
third-party-amazon-trouble-shooting-account-link = Отстраняване на проблеми със синхронизирането на акаун
...
third-party-amazon-private-account = Личен акаун
third-party-amazon-public-account = Публичен акаун
third-party-amazon-api-key = API клю
third-party-amazon-start-using-client = Започнете да използвате { $var0 } клиен
