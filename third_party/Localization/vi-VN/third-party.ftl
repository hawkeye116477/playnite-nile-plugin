...
third-party-amazon-settings-import-installed-label = Nhập vào các trò chơi đã được cài đặt
third-party-amazon-settings-import-uninstalled-label = Nhập vào các trò chơi chưa được cài đặt
